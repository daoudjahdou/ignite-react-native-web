...
async function install(context) {
  const { filesystem, parameters, ignite, print, system } = context;
  ...
  try {
    ...
    await system.spawn(
      `ignite add /Users/daoud/workspace/goodappe/ignite/ignite-react-native-web ${debugFlag}`,
      { stdio: "inherit" }
    );
  } catch (e) {
    console.log(e);
  ...
  await ignite.copyBatch(
    context,
    templates,
    { name: name, igniteVersion: ignite.version },
    {
